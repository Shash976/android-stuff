...
class MainActivity : ComponentActivity() {
            ...
            LittleLemonTheme {
                ...
                Column(
                    ...
                    if (searchPhrase.value.isNotEmpty()) {
                        menuItems = menuItems.filter { searchPhrase.value.lowercase() in it.title.lowercase() }
                    }
                    var x = listOf<String>("a","b")
    ...
    private suspend fun fetchMenu(): List<MenuItemNetwork> {
        val menuNetwork : MenuNetwork = httpClient.get("https://raw.githubusercontent.com/Meta-Mobile-Developer-PC/Working-With-Data-API/main/littleLemonSimpleMenu.json").body()
